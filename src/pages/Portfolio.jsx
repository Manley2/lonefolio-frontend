...
export default function Portfolio() {
    ...
    return (
        <div className="min-h-screen bg-[#f9fbfd] dark:bg-[#0f111a] text-slate-800 dark:text-slate-100 transition-all duration-300 font-sans relative overflow-hidden">
            
            {/* Ambient Background Mesh Blobs */}
            <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none z-0">
                <div className="absolute -top-40 -left-40 w-[550px] h-[550px] rounded-full bg-blue-500/10 dark:bg-blue-600/5 blur-[130px]"></div>
                <div className="absolute -bottom-40 -right-40 w-[550px] h-[550px] rounded-full bg-purple-500/10 dark:bg-purple-600/5 blur-[130px]"></div>
            </div>
            ...
            <nav className="max-w-7xl mx-auto px-6 py-5 flex items-center justify-between border-b border-slate-200/50 dark:border-phoenix-border-dark relative z-10 select-none">
                ...
                <div className="flex items-center gap-6">
                    ...
                    <button
                        onClick={toggleTheme}
                        className="p-2 rounded-xl bg-white dark:bg-[#101424] border border-slate-200/60 dark:border-phoenix-border-dark hover:bg-slate-50 dark:hover:bg-slate-900 active:scale-95 shadow-sm transition-all duration-200 cursor-pointer text-slate-750 dark:text-yellow-450 text-xs"
            ...
            <section id="skills" className="max-w-6xl mx-auto px-6 py-16 relative z-10 border-t border-slate-200/50 dark:border-phoenix-border-dark/50">
                ...
                <div className="grid md:grid-cols-3 gap-6">
                    ...
                    <div className="bg-white dark:bg-[#141824] border border-slate-200/60 dark:border-phoenix-border-dark p-6 rounded-2xl shadow-sm hover:shadow-md transition-all duration-300">
                        <div className="w-10 h-10 bg-blue-50 dark:bg-blue-955/20 text-[#3874ff] dark:text-blue-400 rounded-xl flex items-center justify-center font-bold text-lg select-none mb-5">
                            ⚛️
                        </div>
                        ...
                        <p className="text-xs text-slate-450 dark:text-slate-400 leading-relaxed font-semibold mb-4">
                    ...
                    {/* Backend Card */}
                    <div className="bg-white dark:bg-[#141824] border border-slate-200/60 dark:border-phoenix-border-dark p-6 rounded-2xl shadow-sm hover:shadow-md transition-all duration-300">
                        <div className="w-10 h-10 bg-purple-50 dark:bg-purple-955/20 text-[#a855f7] dark:text-purple-400 rounded-xl flex items-center justify-center font-bold text-lg select-none mb-5">
                            ⚙️
                        </div>
                    ...
                    <div className="bg-white dark:bg-[#141824] border border-slate-200/60 dark:border-[#222e45] p-6 rounded-2xl shadow-sm hover:shadow-md transition-all duration-300">
                        <div className="w-10 h-10 bg-emerald-50 dark:bg-emerald-955/20 text-emerald-600 dark:text-emerald-400 rounded-xl flex items-center justify-center font-bold text-lg select-none mb-5">
                            💾
                        </div>
                ...
                <div className="grid md:grid-cols-12 gap-8 items-center">
                    ...
                    <div className="md:col-span-7 bg-white dark:bg-[#141824] border border-slate-200/60 dark:border-[#222e45] p-6 rounded-2xl shadow-sm flex flex-col justify-between h-[390px] relative overflow-hidden transition-all duration-300">
                        ...
                        <div>
                            <div className="flex justify-between items-center select-none">
                                <span className="text-[8px] bg-blue-50 dark:bg-blue-955/20 text-[#3874ff] dark:text-blue-450 px-3 py-1 rounded-full font-black uppercase border border-blue-200/50 dark:border-blue-900/30 tracking-widest font-mono">
                                    Featured Project
                                </span>
                            ...
                            <div className="flex flex-wrap gap-2.5 mt-5 font-mono text-[9px] text-slate-450 dark:text-slate-500 font-bold select-none">
                    ...
                    <div className="md:col-span-5 space-y-6">
                        ...
                        <div className="bg-white dark:bg-[#141824] border border-slate-200/60 dark:border-[#222e45] p-5 rounded-2xl shadow-sm hover:translate-y-[-2px] transition duration-200">
                            <span className="text-[8px] bg-purple-50 dark:bg-purple-955/20 text-[#a855f7] dark:text-purple-400 px-2.5 py-0.5 rounded-full font-extrabold uppercase border border-purple-200/35 tracking-wider font-mono">
                                Laravel Engine
                            </span>
                        ...
                        {/* Mini Project 3 */}
                        <div className="bg-white dark:bg-[#141824] border border-slate-200/60 dark:border-[#222e45] p-5 rounded-2xl shadow-sm hover:translate-y-[-2px] transition duration-200">
                            <span className="text-[8px] bg-emerald-50 dark:bg-emerald-955/20 text-emerald-700 dark:text-emerald-400 px-2.5 py-0.5 rounded-full font-extrabold uppercase border border-emerald-200/35 tracking-wider font-mono">
                                WebSockets SPA
                            </span>
                            <h4 className="text-sm font-black text-slate-800 dark:text-white uppercase tracking-tight mt-2.5">
            ...
            <section id="contact" className="max-w-4xl mx-auto px-6 py-16 pb-28 relative z-10 border-t border-slate-200/50 dark:border-phoenix-border-dark/50">
                <div className="bg-white dark:bg-[#141824] border border-slate-200/60 dark:border-phoenix-border-dark rounded-2xl p-6 md:p-10 shadow-xl grid md:grid-cols-12 gap-8 items-center transition duration-300">
                    ...
                    <div className="md:col-span-7">
                        {formSubmitted ? (
                            <div className="bg-emerald-50 dark:bg-emerald-955/20 text-emerald-700 dark:text-emerald-400 p-6 rounded-2xl border border-emerald-200/60 dark:border-emerald-900/30 text-center font-bold text-xs select-none animate-fadeIn">
                            ...
                            <form onSubmit={handleFormSubmit} className="space-y-4">
                                <div className="grid grid-cols-2 gap-4">
                                    <div>
                                        <label className="text-[8.5px] font-extrabold text-slate-400 dark:text-slate-550 uppercase tracking-widest font-mono">Your Name</label>
                                        <input 
                                            type="text" 
                                            placeholder="John Doe" 
                                            value={formData.name}
                                            onChange={(e) => setFormData({ ...formData, name: e.target.value })}
                                            className="mt-1.5 w-full bg-slate-50 dark:bg-slate-900 border border-slate-200/80 dark:border-phoenix-border-dark rounded-xl px-3.5 py-2.5 outline-none text-xs text-slate-800 dark:text-white placeholder-slate-450 font-bold focus:bg-white dark:focus:bg-slate-950 focus:ring-2 focus:ring-blue-500/20 focus:border-[#3874ff] transition-all"
                                            required
                                        />
                                    </div>
                                    <div>
                                        <label className="text-[8.5px] font-extrabold text-slate-400 dark:text-slate-550 uppercase tracking-widest font-mono">Your Email</label>
                                        <input 
                                            type="email" 
                                ...
                                <div>
                                    <label className="text-[8.5px] font-extrabold text-slate-400 dark:text-slate-555 uppercase tracking-widest font-mono">Project Requirements</label>
                                    <textarea 
                                        rows="3" 
                                        placeholder="Describe your SaaS project..."
                                        value={formData.message}
                                        onChange={(e) => setFormData({ ...formData, message: e.target.value })}
                                        className="mt-1.5 w-full bg-slate-50 dark:bg-slate-900 border border-slate-200/80 dark:border-phoenix-border-dark rounded-xl px-3.5 py-2.5 outline-none text-xs text-slate-800 dark:text-white placeholder-slate-450 font-bold focus:bg-white dark:focus:bg-slate-950 focus:ring-2 focus:ring-blue-500/20 focus:border-[#3874ff] transition-all resize-none"
                                        required
                                    ></textarea>
                                </div>
                                <button
